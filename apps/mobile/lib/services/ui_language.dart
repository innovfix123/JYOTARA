...
const tamilUi = <String, String>{
  ...
  'Birth details go to our calculation service; chart facts and your question go to the language service. Your chart and chat history are saved in encrypted storage on this device. Delete them from the Chart tab. Creating a profile turns optional research sharing off; you can choose it separately in Account. Server deletion controls are not yet available in this test build.': 'பிறப்பு விவரங்கள் கணக்கீட்டுச் சேவைக்கும், ஜாதக விவரங்களும் உங்கள் கேள்வியும் மொழிச் சேவைக்கும் அனுப்பப்படும். உங்கள் ஜாதகமும் உரையாடல்களும் இந்தச் சாதனத்தில் மறையாக்கம் செய்து சேமிக்கப்படும். ஜாதகம் பகுதியில் அவற்றை நீக்கலாம். புதிய பிறப்பு விவரங்களை உருவாக்கும்போது ஆய்வுக்கான விருப்பப் பகிர்வு முடக்கப்படும்; கணக்கு பகுதியில் தனியாகத் தேர்ந்தெடுக்கலாம். சேவையகத் தரவுகளை நீக்கும் வசதி இந்தச் சோதனைப் பதிப்பில் இன்னும் இல்லை.',
