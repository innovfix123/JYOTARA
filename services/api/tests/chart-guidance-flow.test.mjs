...
const route = file => url(compile(read(file))
  ...
  .replace('@/lib/profile-overview', url(compile(read('../lib/profile-overview.ts')))).replace('@/lib/astrology-evidence', evidence).replace('@/lib/guidance-language', language).replace('@/lib/consultation-writer', url(compile(read('../lib/consultation-writer.ts'))))
